...
.item-row{display:flex;justify-content:space-between;font-size:14px;padding:8px 0;border-bottom:1px solid #f0f0f0;}
...
<div class="confirm-wrap">
  <div class="confirm-box">
    ...
    <div class="item-row"><span><?=htmlspecialchars($i['name'])?> x<?=$i['quantity']?></span><span>R<?=number_format($i['price']*$i['quantity'],2)?></span></div>
    <?php endforeach; ?>
