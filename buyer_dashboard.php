...
<div class="dash-wrap">
  ...
  <table class="orders-table">
    <thead><tr><th>Order Ref</th><th>Date</th><th>Amount</th><th>Status</th><th>Actions</th></tr></thead>
    <tbody>
    ...
    <tr>
      ...
      <td><a class="btn btn-sm" href="order_details.php?order_id=<?=$o['order_id']?>">Details, Reviews, Dispute</a></td>
    </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
