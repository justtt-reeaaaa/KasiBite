...
require 'config.php';
$featured = $pdo->query("
    SELECT p.*, c.category_name, c.default_image,
    ...
    FROM products p JOIN categories c ON p.category_id = c.category_id WHERE p.status='active' LIMIT 6
...
<div class="featured-section">
    ...
    <div class="feat-grid">
        <?php foreach($featured as $p):
            ...
            $img = $img ?: ($p['default_image'] ?: $defaultImg);
        ?>
        <div class="feat-card">
            ...
            <div class="feat-card-body">
                ...
                <p style="font-size:11px;color:#f39c12;margin-bottom:6px;"><?= str_repeat('★', round($p['avg_rating'])) ?> <?= $p['avg_rating'] ?> (<?= $p['review_count'] ?>)</p>
                <?php endif; ?>
