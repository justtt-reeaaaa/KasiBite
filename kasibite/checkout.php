...
$stmt=$pdo->prepare("SELECT c.cart_id,c.quantity,p.product_id,p.name,p.price FROM cart c JOIN products p ON c.product_id=p.product_id WHERE c.user_id=?");
...
<div class="checkout-wrap">
  <div class="checkout-left">
    <div class="section-box">
      ...
      <div class="form-group"><label>Collection Notes</label><input type="text" id="collection_notes" placeholder="e.g. Collect at seller stall, Soweto Taxi Rank"></div>
    ...
    <div class="section-box">
      ...
      <div class="sim-note">⚠️ <strong>Simulation Mode:</strong> No real payment is processed. This is a demo for academic purposes.</div>
    </div>
  </div>
